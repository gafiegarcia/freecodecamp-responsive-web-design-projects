...
- [ ] Experiment with using Jekyll build by changing the names of some project screenshots to exclude "_" at the start. Take note of whether the image load speed improve.
